...
```{r echo=FALSE, fig.align='center', fig.cap='Possible shapes for the weighting function in robust regression. Source: Wikimedia Commons', out.width='50%'}
knitr::include_graphics('RhoFunctions.png')
```
