...
```{r echo=FALSE, fig.align='center', fig.cap='Example of how Excel can be used to work out the sums-of-squares for one way ANOVA', out.width='100%'}
knitr::include_graphics('One-way_ANOVA_example_in_Excel.png')
```
...
```{r echo=FALSE, fig.align='center', fig.cap='Source: Logan (2010) Biostatistical Design and Analysis Using R', out.width='80%'}
knitr::include_graphics('One-way-ANOVA figure from Logan.png')
```
