...
* `clouds` (txt): [link](https://github.com/hlynch/Biometry2023/tree/master/_data/clouds.txt) [1]
* `Prestige`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Prestige.csv) [2]
* `skulls`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/skulls.txt) [3]
* `diabetes`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/diabetes.csv) [4]
* `WaterData`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/WaterData.csv) [5]
* `FoxFurProduction`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/FoxFurProduction.csv) [6]  
* `fish`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/fish.txt) [7]
* `Week-9-Data`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Week-9-Data.txt) [8]
* `bomregions2012`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/bomregions2012.csv) [9]
* `Challenger_data`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Challenger_data.csv) [10]
* `Brogan_et_al_2013_Fig1Data`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Brogan_et_al_2013_Fig1Data.xlsx) [11]
* `fruit_flies`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/fruit_flies.csv) [12]
* `medley`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/medley.csv) [13]
* `quinn`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/quinn.csv) [14]
* `TwoWayANOVAdata_balanced`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/TwoWayANOVAdata_balanced.csv) [15]
* `TwoWayANOVAdata`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/TwoWayANOVAdata.csv) [16]
* `TwoWayANOVAdata`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/TwoWayANOVAdata.csv) [17]
* `flatworms`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/flatworms.csv) [18]
* `flies`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/flies.txt) [19]
* `rats`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/rats.txt) [20]
* `tobacco`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/tobacco.csv) [21]
* `crabs`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/crabs.csv) [22]
* `frogs`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/frogs.csv) [23]
* `MammalLifeHistory`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/MammalLifeHistory.csv) [24]
* `Historic-lichen_data`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Historic-lichen-data.xls) [25]
* `Lichen-sites-area`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Lichen-sites-area.xls) [26]
* `Temperature_and_isolation`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Temperature_and_isolation.xls) [27]
* `lovett2`: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/lovett2.csv) [28]
...
* Spring 2018 Final: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Final_exam_Spring2018.pdf) [See note below]
...
* Spring 2022 Final: [link](https://github.com/hlynch/Biometry2023/tree/master/_data/Final_exam_Spring2022.pdf) [See note below]
...
$$
Y_{i}~N(\beta_{0}+\beta_{1}SST_{i}+\beta_{1}SST_{i}+\beta_{2}PreyDensity_{i}+\beta_{3}StartingLength_{i}+\beta_{4}I[Group_{i}==\mbox{Adult Female}]++\beta_{5}I[Group_{i}==\mbox{Juvenile Male}]+\beta_{6}I[Group_{i}==\mbox{Juvenile Female}],\sigma^{2})
$$
