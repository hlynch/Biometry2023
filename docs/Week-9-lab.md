...
## -22.353  -8.958   2.198   6.712  18.361 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   8.1505     4.1477   1.965   0.0594 .  
## X            -2.7787     0.2336 -11.893 1.84e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 11.08 on 28 degrees of freedom
## Multiple R-squared:  0.8348,	Adjusted R-squared:  0.8289 
## F-statistic: 141.5 on 1 and 28 DF,  p-value: 1.839e-12
```
...
## t1* 6.3002197  0.200853049  4.63729994
## t2* 0.6615263 -0.006511396  0.07516855
```
