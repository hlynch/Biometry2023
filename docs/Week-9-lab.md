...
## -24.0983  -6.3644   0.6017   7.1818  14.9607 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   2.4552     3.6483   0.673    0.506    
## X            -2.3473     0.2055 -11.422 4.73e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.743 on 28 degrees of freedom
## Multiple R-squared:  0.8233,	Adjusted R-squared:  0.817 
## F-statistic: 130.5 on 1 and 28 DF,  p-value: 4.731e-12
```
...
## t1* 6.3002197  0.392968022  4.79375732
## t2* 0.6615263 -0.007557492  0.07847364
```
