...
## -17.311  -5.414  -1.034   4.422  23.070 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   0.1527     3.3386   0.046    0.964    
## X            -2.2043     0.1881 -11.721 2.59e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 8.915 on 28 degrees of freedom
## Multiple R-squared:  0.8307,	Adjusted R-squared:  0.8247 
## F-statistic: 137.4 on 1 and 28 DF,  p-value: 2.587e-12
```
...
## t1* 6.3002197  0.168341799  4.65456373
## t2* 0.6615263 -0.005094291  0.07544143
```
