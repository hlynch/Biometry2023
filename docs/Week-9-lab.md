...
## -25.4466  -4.9497  -0.3746   5.4968  16.5756 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   1.4412     3.6128   0.399    0.693    
## X            -2.2260     0.2035 -10.938 1.28e-11 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.648 on 28 degrees of freedom
## Multiple R-squared:  0.8104,	Adjusted R-squared:  0.8036 
## F-statistic: 119.7 on 1 and 28 DF,  p-value: 1.282e-11
```
...
## t1* 6.3002197  0.096735655  4.43067827
## t2* 0.6615263 -0.003903956  0.07242324
```
