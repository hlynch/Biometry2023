...
## -21.5927  -5.3617   0.2437   5.1543  27.6126 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -0.2847     3.8020  -0.075    0.941    
## X            -2.1279     0.2142  -9.936 1.11e-10 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 10.15 on 28 degrees of freedom
## Multiple R-squared:  0.779,	Adjusted R-squared:  0.7711 
## F-statistic: 98.72 on 1 and 28 DF,  p-value: 1.11e-10
```
...
## t1* 6.3002197  0.24573464   4.4858427
## t2* 0.6615263 -0.00474326   0.0728229
```
