...
## -16.988  -3.541   1.860   5.751  17.735 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -3.6870     3.4540  -1.067    0.295    
## X            -2.1759     0.1946 -11.184 7.71e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.224 on 28 degrees of freedom
## Multiple R-squared:  0.8171,	Adjusted R-squared:  0.8105 
## F-statistic: 125.1 on 1 and 28 DF,  p-value: 7.705e-12
```
...
## t1* 6.3002197  0.32068014  4.55866051
## t2* 0.6615263 -0.00752095  0.07275374
```
